...
import { ExternalLink, Inbox, Link2, RefreshCw, Search, ShieldCheck, Unplug, Workflow } from "lucide-react";
      ...
      {!isConnected ? (
        <section className="graph-connect-card">
          ...
          <div>
            ...
            <p>Microsoft will ask you to choose the school account and approve read-only inbox access. Your password and MFA stay on Microsoft’s sign-in page.</p>
